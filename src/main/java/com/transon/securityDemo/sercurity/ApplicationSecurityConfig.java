...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/v1/management/roles/**").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/test/BAN").hasAnyRole("ADMIN", "BAN")
                .antMatchers(HttpMethod.GET, "/api/v1/test/BKT").hasAnyRole("ADMIN", "BKT")
                .antMatchers(HttpMethod.GET, "/api/v1/test/RCN").hasAnyRole("ADMIN", "RCN")
                .antMatchers(HttpMethod.GET, "/api/v1/test/CSR").hasAnyRole("ADMIN", "CSR")
                .antMatchers(HttpMethod.GET, "/api/v1/test/CUS").hasAnyRole("ADMIN", "CUS")
